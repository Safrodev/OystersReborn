...
public enum OysterBreed {
    ...
    OysterBreed(String name, String containerName, String pearlName, Item resourceItem, OysterBreed.OysterTier tier) {
        identifier = new Identifier(OystersReborn.MODID, name);
        containerIdentifier = new Identifier(OystersReborn.MODID, containerName);
        oysterBlock = new OysterBlock();
        oysterBlockItem = new OysterBlockItem(getOysterBlock(), new Item.Settings().group(OystersReborn.oysterGroup).maxCount(8), tier);
    ...
    /**
     * The tier at which the resource oyster can be mutated withe
     */
